"""
Prototype Agent
Reads a GitHub Issue title + body, asks Claude to generate a plan and a
...
def generate_prototype(title: str, body: str) -> tuple[str, str]:
    """
    Ask Claude to produce a plan and a full HTML prototype.
...
---
*Generated by Claude `{MODEL}` · [View HTML source]({source_url})*"""
